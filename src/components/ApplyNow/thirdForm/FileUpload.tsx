...
//   }
  ...
  return (
    <div
     className={`cursor-pointer place-content-center   rounded-lg p-8 text-center transition-colors ${
    ...
    >
      ...
      <input
        ...
        accept=".jpeg,.jpg,.png,image/jpeg,image/png,application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document"
